...
async def handleChat(request: Request):
    ...
    try: 
        ...
        sysMsg = {
            "role": "system",
            "content": userMsg['system_content'] + "\n\nInformation you currently know to give personalized response:\n" + str(personalData)
        }
...
app.add_middleware(
    CORSMiddleware,
    # allow_origins=["https://6761b19fe00b66a324897a25--companion.netlify.app","http://localhost:8081"],  # Allows all origins (you can limit this to specific domains)
    allow_origins=["*"],
